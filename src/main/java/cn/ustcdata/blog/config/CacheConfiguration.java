package cn.ustcdata.blog.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(cn.ustcdata.blog.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(cn.ustcdata.blog.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
